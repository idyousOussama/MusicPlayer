...
class FileCantPlayFragment : Fragment() {
    private var feedBackListener : FeedbackListener? = null
    private var _binding: FragmentFileCantPlayBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentFileCantPlayBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.feedBackFileCantPlayExplainInpute.addTextChangedListener {
            val feedbackText = binding.feedBackFileCantPlayExplainInpute.text.toString()
        ...
        subBtnListner =object : SubmitButtonListener {
            override fun onSubmitBtnClicked() {
                binding.feedBackFileCantPlayExplainInpute.setText("")
            }
