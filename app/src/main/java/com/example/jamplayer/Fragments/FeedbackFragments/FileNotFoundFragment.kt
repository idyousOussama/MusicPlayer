...
class FileNotFoundFragment : Fragment() {
    ...
    private var _binding: FragmentFileNotFoundBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentFileNotFoundBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.feedBackFileNotFoundExplainInpute.addTextChangedListener {
            val feedbackText =binding.feedBackFileNotFoundExplainInpute.text.toString()
        ...
        subBtnListner =object : SubmitButtonListener {
            override fun onSubmitBtnClicked() {
                binding.feedBackFileNotFoundExplainInpute.setText("")
            }
